export const site = {
  ...
  portfolio: [
    ...
    {
      id: "zcleaning",
      title: "ZC Cleaning Services",
      category: "Bilingual service website",
      location: "Austin, Texas",
      metric: "Live in production",
      href: "https://www.zcleaningservices.com",
    ...
    {
      id: "ultrashine",
      title: "UltraShine Inc.",
      category: "Spanish-first local service website",
      location: "California, United States",
      metric: "Live in production",
      href: "https://www.ultrashineca.com",
      hrefLabel: "Visit live site",
  ...
  experience: [
    ...
    },
    {
      ...
      highlights: [
        "Endpoint security collaboration",
        "Operational cybersecurity support",
        "Security research and disciplined technical analysis",
      ],
    },
  ],
  education: [
    {
      ...
      degree: "Cybersecurity, Project Management",
      start: "September 2021",
      end: "August 2023",
    },
    {
      school: "Edutin Academy",
      degree: "Associate's degree, Computer and Information Sciences and Support Services",
      start: "January 2023",
      end: "February 2024",
    },
  ],
  ...
  "@graph": [
    {
      ...
      worksFor: {
        "@type": "Organization",
        name: "FlowMind Studio",
        url: site.links.flowmind,
      },
      address: {
        "@type": "PostalAddress",
